...
\begin{tabular}{|c|c|}
\hline
\begin{tabular}[c]{@{}c@{}}Introdução a Programação\cite{r2}\\ (IF669)\end{tabular}                & \begin{tabular}[c]{@{}c@{}}Inicia o aluno nos conceitos iniciais de\\ programação, indispensáveis na disciplina.\end{tabular}                                       \\ \hline
\begin{tabular}[c]{@{}c@{}}Paradigmas em Linguagens\\ de Programação (IF686)\cite{r3}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Continua o desenvolvimento dos conceitos\\ apresentados na IF669 e abrangem parte \\ dos tratados na Programação Funcional.\end{tabular} \\ \hline
{\ul Matemática Discreta (IF670)\\ \cite{r6}}                                                         & \begin{tabular}[c]{@{}c@{}}Discute estruturas matemáticas e provas\\ importantes para a disciplina.\end{tabular}                                                    \\ \hline
\end{tabular}
\end{table}

...
\begin{tabular}[c]{@{}c@{}}IF685 \\  Gerenciamento de \\ Dados e Informação\end{tabular} & \begin{tabular}[c]{@{}l@{}}Tem como objeto de estudo o gerenciamento de\\ diferentes tipos de redes incluindo a de computa-\\dores. Todavia, possui da mais ênfase nos proto-\\colos, no que tange a área de redes de computa-\\dores, por exemplo TCP e IP.
\cite{gerenciamentoDados}
\end{tabular}                       \\ \hline
\begin{tabular}[c]{@{}c@{}}IF678\\  Infra-estrutura de \\ Comunicação\end{tabular} & \begin{tabular}[c]{@{}l@{}}As duas disciplinas estudam métodos para comu-\\nicação via computação. Portanto possuem temas\\ de estudo em comum, como: Modelo OSI e intro-\\dução à redes de computadores.
